...
local function setup_blended_cursorline()
  ...
  vim.api.nvim_create_autocmd("InsertEnter", {
    group = group,
    callback = function() vim.api.nvim_set_hl(0, "CursorLine", { bg = insert_bg }) end,
  })
  ...
  vim.api.nvim_create_autocmd("ModeChanged", {
    group = group,
    pattern = "*:[vV\x16]*",
    callback = function() vim.api.nvim_set_hl(0, "CursorLine", { bg = visual_bg }) end,
  })
  ...
  vim.api.nvim_create_autocmd("ModeChanged", {
    group = group,
    pattern = "*:n",
    callback = function() vim.api.nvim_set_hl(0, "CursorLine", { bg = normal_bg }) end,
  })
end
